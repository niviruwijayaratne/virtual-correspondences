...
def compute_rt(K1_mat, K2_mat, F_mat, correspondences):
    ...
    points, R_mat, t_mat, mask = cv2.recoverPose(E_mat, np.float32(pts2), np.float32(pts1), K1_mat, 50)
    return R_mat, t_mat
...
if __name__ =='__main__':
    ...
    correspondences = utils.read_data(r'D:\adev\virtual-correspondences\images\messi\correspondences.npy')
    F_mat = utils.read_data(r'D:\adev\virtual-correspondences\images\out\messi_f_mat.npy')
