...
class DensePoseMethods:
    def __init__(self, data_dir=Path("/home/ubuntu/virtual-correspondences/data")):
        ALP_UV = loadmat(str(data_dir / "UV_data/UV_Processed.mat"))
        ...
        self.UV_symmetry_transformations = loadmat(
            str(data_dir / "UV_data/UV_symmetry_transforms.mat")
        )
    ...
    def get_symmetric_densepose(self, I, U, V, x, y, Mask):
        ...
        for i in range(24):
            if i + 1 in I:
                ...
                ###
                V_sym[jj] = self.UV_symmetry_transformations["V_transforms"][0, i][
                    V_loc, U_loc
                ]
                U_sym[jj] = self.UV_symmetry_transformations["U_transforms"][0, i][
                    V_loc, U_loc
                ]
        ##
