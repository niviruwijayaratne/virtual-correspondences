...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output", type=str, default=None, help="directory to save output result file"
    )
    parser.add_argument(
        "--show_path",
        type=str,
    ...
    parser.add_argument(
        "--render_choice", type=str, default="hq", help="Render choice parameters"
    )
    parser.add_argument(
        "--palette", type=str, default="segmentation", help="Color theme"
    )
    parser.add_argument(
        "--bbox_thr", type=float, default=0.99, help="Bounding box score threshold"
    )
    parser.add_argument(
        "--draw_bbox",
        action="store_true",
